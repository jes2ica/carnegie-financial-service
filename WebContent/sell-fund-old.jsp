...
<html lang="en">
  <head>
    ...
    <link href="./css/pages/buyfund.css" rel="stylesheet" /> 
		...
		<div class="row">
			...
			<div class="span3">
				...
				<div class="account-container">
					...
					<!-- form class="faq-search"><input type="text" name="search" placeholder="Search by Keyword"></form> -->
				...
				<ul id="main-nav" class="nav nav-tabs nav-stacked">
					...
					<li>
						<a  class="active" href="./sellfund_init.action">
							<i class="icon-file"></i>
							Sell Fund	
						</a>
					</li>
				...
				<div class="widget widget-table">
					...
					<div class="widget-content">
						<table class="table table-striped table-bordered">
							...
							<tbody>
								<!-- s:form id="sellfund" class="form-horizontal" action="sellfund_sellFund" method="post">  -->
								<s:iterator value="positions" status="stuts">
								<tr>
									<td>${stuts.count}</td>
									<td><s:property value="fundId" /></td>
									<td><s:property value="shares" /></td>
									
									<td>
									<form action="sellfund_sellFund" method="post">
									
									<input type="hidden" name="positionId" value=${ positionId } />
									
									<input type="text" name="sellshares" class="" id="sellshares" /> shares
						...
						<!-- table class="table table-striped table-bordered">
							...
							<tbody>
								<tr>
									...
									<td>${description}</td>
									<td>
										<form action="buyfund_buyAFund" method="post">
